...
const Team = () => {
  return (
    <main className="py-16 lg:py-28 2xl:py-32 px-5 lg:px-[1.9rem] xl:px-20 desktop:px-28 2xl:px-48 largesceen:px-80 fourk:px-[40rem]  flex flex-col-reverse lg:flex-row justify-center lg:gap-x-44 xl:gap-x-56 2xl:gap-x-72 largesceen:gap-x-96 items-center   xl:mt-20 ">
      <section className="relative">
        ...
        <div>
          ...
          <Image src={team3} alt="team members" className="team-bs absolute rounded-[0.625rem] right-16 xl:right-20 largesceen:right-28 -top-[4.5rem] sm:-top-20 xl:-top-28 largesceen:-top-36 w-14 sm:w-16 xl:w-[5.5rem] largesceen:w-[7.438rem] h-auto" />
          ...
          <Image src={team6} alt="team members" className="team-bs absolute rounded-[0.625rem] right-4 sm:right-5 xl:right-[2rem] -bottom-8 sm:-bottom-6 xl:-bottom-10 w-[3rem] sm:w-[3.313rem] xl:w-[4.313rem] largesceen:w-[5.5rem] h-auto z-10" />
