...
const Team = () => {
  ...
  return (
    <main
      ...
      id="about"
      className="overflow-hidden py-16 lg:py-20 2xl:py-32 px-5 lg:px-[1.9rem] xl:px-20 desktop:px-28 2xl:px-48 largesceen:px-80 fourk:px-[40rem] xl:mt-20">
      <div className=" flex flex-col-reverse lg:flex-row justify-center lg:gap-x-44 xl:gap-x-56 2xl:gap-x-72 largesceen:gap-x-96 items-center">
        <section data-aos="fade-right" data-aos-delay="0" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="300" className="relative">
        ...
        <section data-aos="fade-left" data-aos-delay="100" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="300" className="max-lg:pb-32">
      ...
      <section className="pt-16 lg:pt-20 2xl:pt-32  xl:mt-20 largesceen:mt-28 flex flex-col lg:flex-row justify-center lg:gap-x-44 xl:gap-x-56 2xl:gap-x-72 largesceen:gap-x-96 items-center">
        <section data-aos="fade-right" data-aos-delay="0" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="300" className="max-lg:py-16 ">
        ...
        <section data-aos="fade-left" data-aos-delay="100" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="300" className="relative mt-2 sm:mt-4 lg:mt-0">
          <Image
            src={app}
            alt="app"
            className="rounded-lg sm:rounded-[0.938rem] app2 h-[22rem] sm:h-[28rem] desktop:h-[31.375rem] max-lg:object-cover largesceen:h-full w-[14rem] xs:w-[16.125rem] largesceen:w-[17.5rem] z-10 relative"
          />
          <Image
            src={app_content}
            alt="app"
            className="absolute -left-8 xs:-left-10 sm:-left-28 lg:-left-[10rem] top-12 desktop:top-20 largesceen:top-24 app2-content w-[8rem] lg:w-[12.313rem] largesceen:w-[13rem] z-20"
          />
          ...
          <div>
            <Image
              src={app_contect_dot}
              alt="dots"
              className="max-xs:hidden absolute bottom-6 sm:bottom-20 lg:bottom-10 desktop:bottom-20 largesceen:bottom-32 -left-[5.2rem] sm:-left-[7.5rem] h-[3rem] sm:h-[4rem] lg:h-[8.688rem] desktop:h-auto"
            />
