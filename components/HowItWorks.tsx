...
const HowItWorks = () => {
  return (
    <section className="py-8 lg:py-12 xl:py-20 2xl:py-32 px-5 lg:px-[1.9rem] xl:px-20 desktop:px-28 2xl:px-48 largesceen:px-80 fourk:px-[40rem] mb-32 sm:mb-52 lg:mb-72">
