...
const Hero = () => {
  return (
    <main className="relative pt-28 2xl:pt-32 overflow-hidden z-10">
      <section className="flex flex-col items-center lg:items-start lg:flex-row justify-center gap-x-36 desktop:gap-x-40 2xl:gap-x-36 largesceen:gap-x-0 largesceen:justify-between px-5 lg:px-[1.9rem]x xl:px-20 desktop:px-28 2xl:px-48 largesceen:px-80 fourk:px-[40rem]">
        <div>
      ...
      <Image src={wave} alt="wave" className="w-full absolute -bottom-1 sm:-bottom-4 largesceen:-bottom-6 fourk:-bottom-8 right-0  z-50" />
    </main>
  );
};
